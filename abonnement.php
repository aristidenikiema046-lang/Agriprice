    ...
    <div class="container mt-4">
        ...
        <div class="admin-banner mb-4 d-flex justify-content-between align-items-center shadow-sm">
            <div>
                ...
                <span class="d-none d-md-inline">| Accès aux validations et paiements</span>
            </div>
                    ...
                    <div class="card h-100 shadow-sm border-0">
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                ...
                                <a href="api/process_payment.php?type=mise_en_relation&id=<?php echo $producer_id; ?>" 
                                   class="btn btn-warning w-100 rounded-pill btn-sm fw-bold" 
                                   onclick="return confirm('Débloquer les coordonnées de ce membre ?')">
                                    Débloquer
                                </a>
                            <?php endif; ?>
                        </div>
